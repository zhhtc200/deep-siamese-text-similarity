...
tf.flags.DEFINE_string(
    "training_files", "person_match.train2", "training file (default: None)")
tf.flags.DEFINE_integer(
    "hidden_units", 50, "Number of hidden units in softmax regression layer (default:50)")
...
with tf.Graph().as_default():
    ...
    tr_op_set = optimizer.apply_gradients(
    ...
    for nn in xrange(sum_no_of_batches * FLAGS.num_epochs):
        ...
        if current_step % FLAGS.evaluate_every == 0:
            ...
            dev_batches = inpH.batch_iter(
                list(zip(dev_set[0], dev_set[1], dev_set[2])), FLAGS.batch_size, 1)
